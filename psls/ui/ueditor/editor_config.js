...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["FullScreen","Source","InsertOrderedList","Undo","Redo","Link","ClearDoc","Emotion","InsertImage","Time","Bold","Italic","Underline","JustifyLeft","JustifyCenter","FormatMatch","FontFamily","FontSize","RemoveFormat","ForeColor","InsertTable","Indent","BackColor","Attachment"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'fullscreen':'','source':'','insertorderedlist':'','undo':'','redo':'','link':'','cleardoc':'','emotion':'','insertimage':'','time':'','bold':'','italic':'','underline':'','justifyleft':'','justifycenter':'','formatmatch':'','fontfamily':'','fontsize':'','removeformat':'','forecolor':'','inserttable':'','indent':'','backcolor':'','attachment':''}
