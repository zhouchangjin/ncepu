...
if(_61.text){
$(_60).html("<span class=\"l-btn-left\"><span class='l-btn-icon'></span>"+"<span class=\"l-btn-text\">"+_61.text+"</span>"+"</span>");
if(_61.iconCls){
$(_60).find(".l-btn-icon").addClass(_61.iconCls);
$(_60).find(".l-btn-text").css("padding-left","20px");
}
}else{
